...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    if (res.ok) {
      ...
      else if (data.role === "owner") navigate("/post-accommodation");
  ...
  return (
    <div className="login-page">
      <div className="form">
        ...
        {from && !showForgot && (
          <p className="alert-msg">Please log in to continue</p>
        )}
        ...
        {!showForgot ? (
          ...
          <form onSubmit={handleForgotPassword}>
            ...
            <p className="forgot-link" onClick={() => setShowForgot(false)}>
              Back to Login
            </p>
          </form>
        )}
        ...
        {!showForgot && (
          <p className="register-link">
            Don't have an account?{" "}
            <span onClick={() => navigate("/register", { state: { from } })}>
              Register here
            </span>
          </p>
        )}
